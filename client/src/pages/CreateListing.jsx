    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                {/* Right coloumn Image Upload */}
                <div className='flex flex-col flex-1 gap-4'>
                    <p className='font-semibold'>Images:
                        <span className='font-normal text-gray-600 ml-2'>The first image will be the cover (max 6)</span></p>
                    <div className='flex gap-4'>
                        <input onChange={(e) => setFiles(e.target.files)} type='file' multiple className='border border-grey-300 w-full p-3 rounded' id='images'
                            accept='image/*'
                        />
                    ...
                    <p className='text-red-700 text-sm'> {imageUploadErrors && imageUploadErrors} </p>
                    {
